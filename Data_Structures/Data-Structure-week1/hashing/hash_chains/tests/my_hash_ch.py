...
class QueryProcessor:
    ...
    def read_test_query(self,str_line):
        return Query(str_line)
    ...
    def process_test_queries(self):
        ...
        for line in file:
            count = count + 1;
            if count > 2 :self.process_query(self.read_test_query(line.split()))
#            self.process_query(self.read_test_query(line))


if __name__ == '__main__':
    #bucket_count = int(input())
    proc = QueryProcessor(43)
    proc.process_test_queries()
		file1 = open('out.dat','r')
		file2 = open('06.a','r')
